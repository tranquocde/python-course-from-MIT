...
class BeforeTrigger(TimeTrigger): #checked
    def __init__(self, time): #time is a string, we need to convert it to datetime object
        super().__init__(time)
    def evaluate(self, story): #time is a datetime object
        return self.time > story.get_pubdate()
class AfterTrigger(TimeTrigger): #checked
    def __init__(self, time):
        super().__init__(time)
    def evaluate(self, story): #time is a NewsStory object
        return self.time < story.get_pubdate()
...
if __name__ == '__main__':
    ...
    print(story.get_desription() == 'test description')
